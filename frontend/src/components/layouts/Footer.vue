        ...
        <div class="row">
          <div class="col-xs-12 col-sm-6 col-md-4">
            <div class="widget subscribe no-box">
              <h5 class="widget-title">
                <i class="fa-2x fad fa-burger-soda mr-2"></i>Food Site<span></span>
              </h5>
          ...
          <div class="col-xs-12 col-sm-6 col-md-4">
            <div class="widget no-box">
              ...
              <ul class="thumbnail-widget">
                ...
                <li>
                  <div class="thumb-content">
                    <router-link to="/search">Serach Food</router-link>
                  </div>
                </li>
              </ul>
            </div>
          ...
          <div class="col-xs-12 col-sm-6 col-md-4">
            <div class="widget no-box">
              ...
              <p>
                <a href="mailto:nilanjan172nsvian@gmail.com" title="glorythemes"
                  >contact@foodsite.com</a
                >
              </p>
              <ul class="social-footer2">
                <li class="">
                  <a title="youtube" target="_blank" href="https://www.youtube.com/@nil1729"
                    ><img
                      alt="youtube"
                      width="30"
                      height="30"
                ...
                <li class="">
                  <a href="https://twitter.com/@nil1729" target="_blank" title="Twitter"
                    ><img
                      alt="Twitter"
                      width="30"
                      height="30"
